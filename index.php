...
<html lang="en">
	...
	<body>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="header-content-right">
							...
							<div class="">
								<a href="#" class="btn btn-outline-secondary btn-lg mt-2 header-btn blanco">Read More</a>
							</div>
						</div>
					</div>
				</div>
		...
		<section id="testimonial">
			<div class="container">
				<p class="h2 mb-2">
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus perferendis vitae nam a sit nesciunt
					voluptas, nobis sed fugiat officia veritatis facere quaerat blanditiis eveniet suscipit facilis explicabo
					earum maiores?
				</p>
			...
			<div class="container">
				<div class="row my-5">
					<div class="col-md-6">
						...
						<p>
							Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sunt dolores aperiam eligendi voluptatibus
							veritatis, voluptates explicabo, fugit vero omnis sint magni pariatur tempora nulla magnam ex voluptas!
							Itaque, vitae voluptas?
						</p>
					</div>
					<div class="col-md-6">
						<h2>Lorem, ipsum dolor.</h2>
						...
						<div class="card-columns">
							<div class="card" style="width: 20rem">
								...
								<div class="card-body">
									...
									<p class="card-text">
										Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem minus repudiandae earum ducimus
										suscipit commodi magni similique ex porro, consequuntur nesciunt quos adipisci quaerat aliquam
										perspiciatis quisquam iusto quis culpa!
									</p>
						...
						<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img src="img/IMG-20190223-WA0136.jpg" class="imgdimension d-block w-100" alt="..." />
								...
								<div class="carousel-item">
									<img src="img/IMG-20191013-WA0022.jpg" class="imgdimension d-block w-100" alt="..." />
									<div class="carousel-caption d-none d-md-block">
								...
								<div class="carousel-item">
									<img src="img/IMG-20191127-WA0059.jpg" class="imgdimension d-block w-100" alt="..." />
									<div class="carousel-caption d-none d-md-block">
								...
								<div class="carousel-item">
									<img src="img/IMG-20191127-WA0068.jpg" class="imgdimension d-block w-100" alt="..." />
									<div class="carousel-caption d-none d-md-block">
										<h5>Second slide label</h5>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
									</div>
								...
								<div class="carousel-item">
									<img src="img/IMG-20191127-WA0069.jpg" class="imgdimension d-block w-100" alt="..." />
									<div class="carousel-caption d-none d-md-block">
										<h5>Second slide label</h5>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
									</div>
								...
								<div class="carousel-item">
									<img src="img/IMG-20191127-WA0072.jpg" class="imgdimension d-block w-100" alt="..." />
									<div class="carousel-caption d-none d-md-block">
										<h5>Second slide label</h5>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
									</div>
